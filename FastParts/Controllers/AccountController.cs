    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // 🔍 Agrega este bloque aquí, antes de la validación:
                System.Diagnostics.Debug.WriteLine("✅ Usuario encontrado: " + (user != null));
                if (user != null)
                {
                    bool confirmado = await UserManager.IsEmailConfirmedAsync(user.Id);
                    System.Diagnostics.Debug.WriteLine("📧 Email confirmado: " + confirmado);
                }
